                ...
                },
                {
                    fn NativeDepositNotSupported(
                        ...
                        <NativeDepositNotSupported as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeMintBurnErrors::NativeDepositNotSupported)
                    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<BridgeMintBurnInstance<P, N>>,
    > {
        BridgeMintBurnInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        BridgeMintBurnInstance::<P, N>::deploy_builder(__provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<BridgeMintBurnInstance<P, N>> {
