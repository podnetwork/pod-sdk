...
```solidity
library AttestedTx {
    struct AttestedTx { bytes32 hash; uint64 committee_epoch; }
}
```*/
#[allow(
...
```*/
    ...
    const _: () = {
        ...
        #[doc(hidden)]
        impl ::core::convert::From<AttestedTx> for UnderlyingRustTuple<'_> {
            fn from(value: AttestedTx) -> Self {
                (value.hash, value.committee_epoch)
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>> for AttestedTx {
            fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                Self {
                    hash: tuple.0,
                    committee_epoch: tuple.1,
                }
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolValue for AttestedTx {
            type SolType = Self;
        }
        #[automatically_derived]
        impl alloy_sol_types::private::SolTypeValue<Self> for AttestedTx {
            #[inline]
            fn stv_to_tokens(&self) -> <Self as alloy_sol_types::SolType>::Token<'_> {
                (
                    ...
                    <alloy::sol_types::sol_data::Uint<
                        64,
                    > as alloy_sol_types::SolType>::tokenize(&self.committee_epoch),
                )
            }
            #[inline]
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolType for AttestedTx {
            type RustType = Self;
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolStruct for AttestedTx {
            const NAME: &'static str = "AttestedTx";
            #[inline]
            fn eip712_root_type() -> alloy_sol_types::private::Cow<'static, str> {
                alloy_sol_types::private::Cow::Borrowed(
                    "AttestedTx(bytes32 hash,uint64 committee_epoch)",
                )
            }
            #[inline]
        ...
        #[automatically_derived]
        impl alloy_sol_types::EventTopic for AttestedTx {
            #[inline]
    ...
    /**Creates a new wrapper around an on-chain [`AttestedTx`](self) contract instance.

See the [wrapper's documentation](`AttestedTxInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> AttestedTxInstance<P, N> {
        AttestedTxInstance::<P, N>::new(address, __provider)
    }
    /**A [`AttestedTx`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`AttestedTx`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct AttestedTxInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for AttestedTxInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("AttestedTxInstance").field(&self.address).finish()
        }
    }
...
See the [wrapper's documentation](`AttestedTxInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> AttestedTxInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> AttestedTxInstance<P, N> {
            AttestedTxInstance {
...
interface BridgeDepositWithdraw {
    ...
    function claim(address token, uint256 amount, address to, AttestedTx.AttestedTx memory attested, bytes memory aggregated_signatures, MerkleTree.MultiProof memory proof) external;
    function claimNative(uint256 amount, address to, AttestedTx.AttestedTx memory attested, bytes memory aggregated_signatures, MerkleTree.MultiProof memory proof) external;
    ...
    function podConfig() external view returns (uint8 thresholdNumerator, uint8 thresholdDenominator, address registry);
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `claim(address,uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))` and selector `0x1df8460d`.
```solidity
function claim(address token, uint256 amount, address to, AttestedTx.AttestedTx memory attested, bytes memory aggregated_signatures, MerkleTree.MultiProof memory proof) external;
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    ...
    ///Container type for the return parameters of the [`claim(address,uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))`](claimCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for claimCall {
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "claim(address,uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))";
            const SELECTOR: [u8; 4] = [29u8, 248u8, 70u8, 13u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `claimNative(uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))` and selector `0x56b35560`.
```solidity
function claimNative(uint256 amount, address to, AttestedTx.AttestedTx memory attested, bytes memory aggregated_signatures, MerkleTree.MultiProof memory proof) external;
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    ...
    ///Container type for the return parameters of the [`claimNative(uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))`](claimNativeCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for claimNativeCall {
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "claimNative(uint256,address,(bytes32,uint64),bytes,(bytes32[],bool[]))";
            const SELECTOR: [u8; 4] = [86u8, 179u8, 85u8, 96u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
...
```*/
    ...
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    /**Function with signature `podConfig()` and selector `0xd328613b`.
```solidity
function podConfig() external view returns (uint8 thresholdNumerator, uint8 thresholdDenominator, address registry);
```*/
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct podConfigCall;
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Default, Debug, PartialEq, Eq, Hash)]
    ///Container type for the return parameters of the [`podConfig()`](podConfigCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
    pub struct podConfigReturn {
        #[allow(missing_docs)]
        pub thresholdNumerator: u8,
        #[allow(missing_docs)]
        pub thresholdDenominator: u8,
        #[allow(missing_docs)]
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<podConfigCall> for UnderlyingRustTuple<'_> {
                fn from(value: podConfigCall) -> Self {
                    ()
                }
            }
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for podConfigCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self
                }
            }
        }
        {
            ...
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (u8, u8, alloy::sol_types::private::Address);
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
                _t: alloy_sol_types::private::AssertTypeEq<UnderlyingRustTuple>,
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<podConfigReturn> for UnderlyingRustTuple<'_> {
                fn from(value: podConfigReturn) -> Self {
                    (
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for podConfigReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        thresholdNumerator: tuple.0,
                        thresholdDenominator: tuple.1,
                        registry: tuple.2,
                    }
                }
            }
        }
        impl podConfigReturn {
            fn _tokenize(
                &self,
            ) -> <podConfigCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                (
                    <alloy::sol_types::sol_data::Uint<
                        8,
                    > as alloy_sol_types::SolType>::tokenize(&self.thresholdNumerator),
                    <alloy::sol_types::sol_data::Uint<
                        8,
                    > as alloy_sol_types::SolType>::tokenize(&self.thresholdDenominator),
                    <alloy::sol_types::sol_data::Address as alloy_sol_types::SolType>::tokenize(
                        &self.registry,
                    ),
                )
        ...
        #[automatically_derived]
        impl alloy_sol_types::SolCall for podConfigCall {
            type Parameters<'a> = ();
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = podConfigReturn;
            type ReturnTuple<'a> = (
                alloy::sol_types::sol_data::Uint<8>,
                alloy::sol_types::sol_data::Uint<8>,
                alloy::sol_types::sol_data::Address,
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "podConfig()";
            const SELECTOR: [u8; 4] = [211u8, 40u8, 97u8, 59u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
...
```*/
    ...
    ///Container for all the [`BridgeDepositWithdraw`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum BridgeDepositWithdrawCalls {
        #[allow(missing_docs)]
    ...
    impl BridgeDepositWithdrawCalls {
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            ...
            <podConfigCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl alloy_sol_types::SolInterface for BridgeDepositWithdrawCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::podConfig(_) => {
                    <podConfigCall as alloy_sol_types::SolCall>::SELECTOR
                }
            ...
            ) -> alloy_sol_types::Result<BridgeDepositWithdrawCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn whitelistedTokens(
                        ...
                        <whitelistedTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::whitelistedTokens)
                    }
                    whitelistedTokens
                },
                {
                    fn getRoleAdmin(
                        ...
                        <getRoleAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::getRoleAdmin)
                    }
                    getRoleAdmin
                },
                {
                    fn tokenData(
                        ...
                        <tokenDataCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::tokenData)
                    }
                    tokenData
                },
                {
                    fn grantRole(
                        ...
                        <grantRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::grantRole)
                    }
                    grantRole
                },
                {
                ...
                },
                {
                    fn unpause(
                        ...
                        <unpauseCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::unpause)
                    }
                    unpause
                },
                {
                ...
                },
                {
                    fn migratedContract(
                        ...
                        <migratedContractCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::migratedContract)
                    }
                    migratedContract
                },
                {
                    fn depositIndex(
                        ...
                        <depositIndexCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::depositIndex)
                    }
                    depositIndex
                },
                {
                    fn pause(
                        ...
                        <pauseCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::pause)
                    }
                    pause
                },
                {
                    fn hasRole(
                        ...
                        <hasRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::hasRole)
                    }
                    hasRole
                },
                {
                    fn configureToken(
                        ...
                        <configureTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::configureToken)
                    }
                    configureToken
                },
                {
                    fn DEFAULT_ADMIN_ROLE(
                        ...
                        <DEFAULT_ADMIN_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::DEFAULT_ADMIN_ROLE)
                    }
                    DEFAULT_ADMIN_ROLE
                },
                {
                    fn bridgeContract(
                        ...
                        <bridgeContractCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::bridgeContract)
                    }
                    bridgeContract
                },
                {
                    fn processedRequests(
                        ...
                        <processedRequestsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::processedRequests)
                    }
                    processedRequests
                },
                {
                    fn migrate(
                        ...
                        <migrateCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::migrate)
                    }
                    migrate
                },
                {
                    fn podConfig(
                        ...
                        <podConfigCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::podConfig)
                    }
                    podConfig
                },
                {
                    fn revokeRole(
                        ...
                        <revokeRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::revokeRole)
                    }
                    revokeRole
                },
                {
                    fn PAUSER_ROLE(
                        ...
                        <PAUSER_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::PAUSER_ROLE)
                    }
                    PAUSER_ROLE
                },
                {
                    fn deposit(
                        ...
                        <depositCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(BridgeDepositWithdrawCalls::deposit)
                    }
                    deposit
                },
                {
                    fn whiteListToken(
                        ...
                        <whiteListTokenCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::whiteListToken)
                    }
                    whiteListToken
                },
                {
                    fn mirrorTokens(
                        ...
                        <mirrorTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawCalls::mirrorTokens)
                    }
                    mirrorTokens
                },
            ];
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                },
                {
                    fn podConfig(
                        ...
                        <podConfigCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(BridgeDepositWithdrawCalls::podConfig)
                    }
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::podConfig(inner) => {
                    <podConfigCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::podConfig(inner) => {
                    <podConfigCall as alloy_sol_types::SolCall>::abi_encode_raw(
                        inner,
                        out,
                    )
                }
    ...
    ///Container for all the [`BridgeDepositWithdraw`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum BridgeDepositWithdrawErrors {
        #[allow(missing_docs)]
    ...
    impl BridgeDepositWithdrawErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
                ...
                },
                {
                    fn InvalidTokenAmount(
                        ...
                        <InvalidTokenAmount as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::InvalidTokenAmount)
                    }
                    InvalidTokenAmount
                },
                {
                    fn ContractMigrated(
                        ...
                        <ContractMigrated as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::ContractMigrated)
                    }
                    ContractMigrated
                },
                {
                    fn SafeERC20FailedOperation(
                        ...
                        <SafeERC20FailedOperation as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::SafeERC20FailedOperation)
                    }
                ...
                },
                {
                    fn AccessControlBadConfirmation(
                        ...
                        <AccessControlBadConfirmation as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BridgeDepositWithdrawErrors::AccessControlBadConfirmation,
                            )
                    }
                ...
                },
                {
                    fn InvalidBridgeContract(
                        ...
                        <InvalidBridgeContract as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::InvalidBridgeContract)
                    }
                ...
                },
                {
                    fn InvalidToAddress(
                        ...
                        <InvalidToAddress as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::InvalidToAddress)
                    }
                    InvalidToAddress
                },
                {
                ...
                },
                {
                    fn RequestAlreadyProcessed(
                        ...
                        <RequestAlreadyProcessed as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::RequestAlreadyProcessed)
                    }
                ...
                },
                {
                    fn MirrorTokenNotFound(
                        ...
                        <MirrorTokenNotFound as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::MirrorTokenNotFound)
                    }
                    MirrorTokenNotFound
                },
                {
                ...
                },
                {
                    fn EnforcedPause(
                        ...
                        <EnforcedPause as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(BridgeDepositWithdrawErrors::EnforcedPause)
                    }
                    EnforcedPause
                },
                {
                    fn AccessControlUnauthorizedAccount(
                        ...
                        <AccessControlUnauthorizedAccount as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                BridgeDepositWithdrawErrors::AccessControlUnauthorizedAccount,
                            )
                    }
    ...
    ///Container for all the [`BridgeDepositWithdraw`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum BridgeDepositWithdrawEvents {
        #[allow(missing_docs)]
        Claim(Claim),
        #[allow(missing_docs)]
    ...
    impl BridgeDepositWithdrawEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BridgeDepositWithdrawEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Claim(inner) => {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`BridgeDepositWithdraw`](self) contract instance.

See the [wrapper's documentation](`BridgeDepositWithdrawInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> BridgeDepositWithdrawInstance<P, N> {
        BridgeDepositWithdrawInstance::<P, N>::new(address, __provider)
    }
    /**A [`BridgeDepositWithdraw`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`BridgeDepositWithdraw`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct BridgeDepositWithdrawInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BridgeDepositWithdrawInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("BridgeDepositWithdrawInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
See the [wrapper's documentation](`BridgeDepositWithdrawInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> BridgeDepositWithdrawInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BridgeDepositWithdrawInstance<P, N> {
            BridgeDepositWithdrawInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
    ...
    > BridgeDepositWithdrawInstance<P, N> {
        ...
        pub fn podConfig(&self) -> alloy_contract::SolCallBuilder<&P, podConfigCall, N> {
            self.call_builder(&podConfigCall)
        }
