...
```*/
    ...
    impl VotingCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ...
            ::core::stringify!(getProposalId),
            ::core::stringify!(createProposal),
            ::core::stringify!(execute),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <castVoteCall as alloy_sol_types::SolCall>::SIGNATURE,
            <getProposalIdCall as alloy_sol_types::SolCall>::SIGNATURE,
            <createProposalCall as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl VotingEvents {
        ...
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(ProposalExecuted),
            ::core::stringify!(VoteCast),
            ::core::stringify!(ProposalCreated),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <ProposalExecuted as alloy_sol_types::SolEvent>::SIGNATURE,
            <VoteCast as alloy_sol_types::SolEvent>::SIGNATURE,
            <ProposalCreated as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
...
See the [wrapper's documentation](`VotingInstance`) for more details.*/
    ...
    >(
        ...
        VotingInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        VotingInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        VotingInstance::<P, N>::deploy_builder(__provider)
    }
