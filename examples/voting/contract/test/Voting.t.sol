...
contract VotingTest is Test {
    ...
    function test_createProposal() public {
        ...
        emit Voting.ProposalCreated(bytes32(0), block.timestamp + 1);

        bytes32 id = voting.createProposal(block.timestamp + 1, 3, createUsers(1));
        console.log("created proposal with id:");
        console.logBytes32(id);
    }

    function test_mustBeParticipantToVote() public {
        bytes32 id = voting.createProposal(block.timestamp + 1, 3, createUsers(10));
    ...
    function test_cantVoteTwice() public {
        ...
        bytes32 id = voting.createProposal(block.timestamp + 1, 3, users);
    ...
    function test_cantCreateProposalAfterDeadline() public {
        ...
        address[] memory users = createUsers(10);
        voting.createProposal(block.timestamp, 3, users);
    }
