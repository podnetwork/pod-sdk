...
See the [wrapper's documentation](`TestMintBalancePrecompileInstance`) for more details.*/
    ...
    >(
        ...
        TestMintBalancePrecompileInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        TestMintBalancePrecompileInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        TestMintBalancePrecompileInstance::<P, N>::deploy_builder(__provider)
    }
