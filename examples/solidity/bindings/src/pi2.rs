    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for ClaimAppended {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 = alloy_sol_types::private::B256::new([
                42u8, 173u8, 219u8, 132u8, 208u8, 51u8, 216u8, 189u8, 80u8, 31u8, 167u8,
                24u8, 86u8, 39u8, 206u8, 226u8, 156u8, 64u8, 129u8, 179u8, 235u8, 107u8,
                23u8, 153u8, 167u8, 45u8, 237u8, 131u8, 41u8, 30u8, 39u8, 132u8,
            ]);
...
```*/
    ...
    impl Pi2Events {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(ClaimAppended),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <ClaimAppended as alloy_sol_types::SolEvent>::SIGNATURE,
        ];
        /// Returns the signature for the given selector, if known.
        #[inline]
        pub fn signature_by_selector(
...
See the [wrapper's documentation](`Pi2Instance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, __provider: P) -> Pi2Instance<P, N> {
        Pi2Instance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        Pi2Instance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        Pi2Instance::<P, N>::deploy_builder(__provider)
    }
    /**A [`Pi2`](self) instance.
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<Pi2Instance<P, N>> {
