...
```*/
    ...
    ///Container for all the [`USDTLike`](self) function calls.
    pub enum USDTLikeCalls {
        #[allow(missing_docs)]
    ...
    impl USDTLikeCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[228u8, 125u8, 96u8, 96u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for USDTLikeCalls {
        const NAME: &'static str = "USDTLikeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<USDTLikeCalls>] = &[
                {
                    fn isBlackListed(
                        data: &[u8],
                        validate: bool,
                        ...
                        <isBlackListedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(USDTLikeCalls::isBlackListed)
                    }
                    isBlackListed
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`USDTLike`](self) contract instance.

See the [wrapper's documentation](`USDTLikeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> USDTLikeInstance<T, P, N> {
        USDTLikeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<USDTLikeInstance<T, P, N>>,
    > {
        USDTLikeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        USDTLikeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`USDTLike`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`USDTLike`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct USDTLikeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for USDTLikeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("USDTLikeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<USDTLikeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> USDTLikeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> USDTLikeInstance<T, P, N> {
            USDTLikeInstance {
