...
```*/
    ...
    ///Container for all the [`IERC6909ContentURI`](self) function calls.
    pub enum IERC6909ContentURICalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC6909ContentURICalls {
        const NAME: &'static str = "IERC6909ContentURICalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC6909ContentURICalls>] = &[
                {
                    fn balanceOf(
                        data: &[u8],
                        validate: bool,
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::transfer)
                    }
                    transfer
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::approve)
                    }
                    approve
                },
                {
                    fn setOperator(
                        ...
                        <setOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::setOperator)
                    }
                    setOperator
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::allowance)
                    }
                    allowance
                },
                {
                    fn isOperator(
                        ...
                        <isOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::isOperator)
                    }
                    isOperator
                },
                {
                    fn tokenURI(
                        ...
                        <tokenURICall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::tokenURI)
                    }
                    tokenURI
                },
                {
                    fn contractURI(
                        ...
                        <contractURICall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::contractURI)
                    }
                    contractURI
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909ContentURICalls::transferFrom)
                    }
                    transferFrom
                },
            ];
    ...
    ///Container for all the [`IERC6909ContentURI`](self) events.
    pub enum IERC6909ContentURIEvents {
        #[allow(missing_docs)]
        Approval(Approval),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC6909ContentURIEvents {
        const NAME: &'static str = "IERC6909ContentURIEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC6909ContentURIEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IERC6909ContentURI`](self) contract instance.

See the [wrapper's documentation](`IERC6909ContentURIInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC6909ContentURIInstance<T, P, N> {
        IERC6909ContentURIInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC6909ContentURIInstance<T, P, N>>,
    > {
        IERC6909ContentURIInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC6909ContentURIInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC6909ContentURI`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC6909ContentURI`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC6909ContentURIInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC6909ContentURIInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC6909ContentURIInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC6909ContentURIInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC6909ContentURIInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC6909ContentURIInstance<T, P, N> {
            IERC6909ContentURIInstance {
