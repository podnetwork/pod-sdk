...
```*/
    ...
    ///Container for all the [`USDCLike`](self) function calls.
    pub enum USDCLikeCalls {
        #[allow(missing_docs)]
    ...
    impl USDCLikeCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[254u8, 87u8, 90u8, 135u8]];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for USDCLikeCalls {
        const NAME: &'static str = "USDCLikeCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<USDCLikeCalls>] = &[
                {
                    fn isBlacklisted(
                        data: &[u8],
                        validate: bool,
                        ...
                        <isBlacklistedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(USDCLikeCalls::isBlacklisted)
                    }
                    isBlacklisted
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`USDCLike`](self) contract instance.

See the [wrapper's documentation](`USDCLikeInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> USDCLikeInstance<T, P, N> {
        USDCLikeInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<USDCLikeInstance<T, P, N>>,
    > {
        USDCLikeInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        USDCLikeInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`USDCLike`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`USDCLike`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct USDCLikeInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for USDCLikeInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("USDCLikeInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<USDCLikeInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> USDCLikeInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> USDCLikeInstance<T, P, N> {
            USDCLikeInstance {
