...
```*/
    ...
    ///Container for all the [`IERC6909`](self) function calls.
    pub enum IERC6909Calls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC6909Calls {
        const NAME: &'static str = "IERC6909Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC6909Calls>] = &[
                {
                    fn balanceOf(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909Calls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                ...
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909Calls::transferFrom)
                    }
                    transferFrom
                },
            ];
    ...
    ///Container for all the [`IERC6909`](self) events.
    pub enum IERC6909Events {
        #[allow(missing_docs)]
        Approval(Approval),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC6909Events {
        const NAME: &'static str = "IERC6909Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC6909Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IERC6909`](self) contract instance.

See the [wrapper's documentation](`IERC6909Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC6909Instance<T, P, N> {
        IERC6909Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC6909Instance<T, P, N>>,
    > {
        IERC6909Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC6909Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC6909`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC6909`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC6909Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC6909Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC6909Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC6909Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC6909Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC6909Instance<T, P, N> {
            IERC6909Instance {
