...
```*/
    ...
    ///Container for all the [`IERC6909Metadata`](self) function calls.
    pub enum IERC6909MetadataCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IERC6909MetadataCalls {
        const NAME: &'static str = "IERC6909MetadataCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IERC6909MetadataCalls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                        ...
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::name)
                    }
                    name
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::transfer)
                    }
                    transfer
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::decimals)
                    }
                    decimals
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::approve)
                    }
                    approve
                },
                {
                    fn symbol(
                        ...
                        <symbolCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::symbol)
                    }
                    symbol
                },
                {
                    fn setOperator(
                        ...
                        <setOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::setOperator)
                    }
                    setOperator
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::allowance)
                    }
                    allowance
                },
                {
                    fn isOperator(
                        ...
                        <isOperatorCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::isOperator)
                    }
                    isOperator
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IERC6909MetadataCalls::transferFrom)
                    }
                    transferFrom
                },
            ];
    ...
    ///Container for all the [`IERC6909Metadata`](self) events.
    pub enum IERC6909MetadataEvents {
        #[allow(missing_docs)]
        Approval(Approval),
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC6909MetadataEvents {
        const NAME: &'static str = "IERC6909MetadataEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC6909MetadataEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`IERC6909Metadata`](self) contract instance.

See the [wrapper's documentation](`IERC6909MetadataInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IERC6909MetadataInstance<T, P, N> {
        IERC6909MetadataInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC6909MetadataInstance<T, P, N>>,
    > {
        IERC6909MetadataInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IERC6909MetadataInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IERC6909Metadata`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC6909Metadata`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC6909MetadataInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IERC6909MetadataInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC6909MetadataInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IERC6909MetadataInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IERC6909MetadataInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC6909MetadataInstance<T, P, N> {
            IERC6909MetadataInstance {
