...
1. **Validates** the transaction  - this includes verifying the signature, checking the nonce, ensuring sufficient balance, and any application-specific validation (e.g. order book rules).
