...
A `recover` call is charged a flat **21,000 gas** at Pod's fixed gas price of 1 gwei (see [Gas](../README.md#gas)). Recovering an account whose funds have already moved through earlier recoveries pays an additional 21,000-gas fee per intermediate account in the chain.
