...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>Network Architecture</strong></td><td>Learn how Pod's streaming, consensus-less protocol works under the hood.</td><td><a href="protocol/network-architecture/README.md">network-architecture</a></td></tr><tr><td><strong>Guides and References</strong></td><td>JSON-RPC endpoints, precompiles, and developer guides.</td><td><a href="api-reference/README.md">api-reference</a></td></tr><tr><td><strong>Network Config</strong></td><td>Chain ID, RPC URLs, faucet, and explorer for the live devnet.</td><td><a href="api-reference/network-config.md">network-config</a></td></tr></tbody></table>
