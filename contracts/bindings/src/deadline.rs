...
pub mod Deadline {
    ...
    >(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<DeadlineInstance<T, P, N>>>
    {
    ...
    impl<T, P, N> ::core::fmt::Debug for DeadlineInstance<T, P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("DeadlineInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        > DeadlineInstance<T, P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<DeadlineInstance<T, P, N>> {
