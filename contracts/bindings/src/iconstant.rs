...
```*/
    ...
    ///Container type for the return parameters of the [`create(bytes32,bytes32)`](createCall) function.
    #[allow(non_camel_case_types, non_snake_case, clippy::pub_underscore_fields)]
    #[derive(Clone)]
...
```*/
    ...
    impl alloy_sol_types::SolInterface for IConstantCalls {
        const NAME: &'static str = "IConstantCalls";
...
See the [wrapper's documentation](`IConstantInstance`) for more details.*/
    ...
    >(
        ...
        IConstantInstance::<T, P, N>::new(address, provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IConstantInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IConstantInstance<T, P, N> {
            IConstantInstance {
    ...
    > IConstantInstance<T, P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<T, &P, createCall, N> {
            self.call_builder(&createCall { key, value })
        }
        ...
        pub fn requireGet(
            ...
            self.call_builder(&requireGetCall { key })
        }
    }
    /// Event filters.
    #[automatically_derived]
